    ...
    for box in boxes:
        ...
        if label >= 0:
            ...
            if tf:
                ...
                cv2.waitKey(5)
                cv2.imwrite("C:/Your Path/Traffic Violation Detection/Identified Pictures/violation_"+str(dcnt)+".jpg", cimg)
                dcnt = dcnt+1
            else:
...
weights_path = "C:/Your Path/Traffic Violation Detection/yolov3.weights"
# set some parameters
net_h, net_w = 416, 416
